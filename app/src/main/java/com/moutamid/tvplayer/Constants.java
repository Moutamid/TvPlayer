...
public class Constants {
    ...
    public static final String post = "http://95.217.210.178/api/v1/devices";
    ...
    public static final String categoriesEvent = "http://95.217.210.178/api/v1/event/categories";
